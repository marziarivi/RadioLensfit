...
double read_coord_ska(const char* filename1, const char* filename2, unsigned int ntimes, unsigned int *nbaselines, double* x,
                      double* y, double threshold, double *len);
