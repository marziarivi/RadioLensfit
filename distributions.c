...
double e_pdf(double e)
{
    ...
    double e_0 = 0.0256;    // circularity parameter
    double a = 0.2539;      // dispersion
        
    double A = 2.43180252985281; // A=1/0.4112176 normalization factor
...
{
    double a = alpha+1.;
    double norm = 1.37;  // norm = 1/729878 normalization factor
